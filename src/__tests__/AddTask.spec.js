...
describe("<AddTask />", () => {
  ...
  describe("Success", () => {
    ...
    it("renders the <AddTask /> main showable using onClick", async () => {
    ...
    it("renders the <AddTask /> main showable using keyDown", async () => {
      const { queryByTestId } = render(<AddTask showAddTaskMain />);
    ...
    it("renders the <AddTask /> project overlay when using onClick", async () => {
      const { queryByTestId } = render(<AddTask showAddTaskMain />);
    ...
    it("renders the <AddTask /> project overlay when using onKeyDown", async () => {
      const { queryByTestId } = render(<AddTask showAddTaskMain />);
    ...
    it("renders the <AddTask /> task date overlay when using onClick", async () => {
      const { queryByTestId } = render(<AddTask showAddTaskMain />);
    ...
    it("renders the <AddTask /> task date overlay when using onKeyDown", async () => {
      const { queryByTestId } = render(<AddTask showAddTaskMain />);
    ...
    it("hides the <AddTask /> main when cancel is clicked using onClick", async () => {
      const { queryByTestId } = render(<AddTask showAddTaskMain />);
    ...
    it("hides the <AddTask /> main when cancel is clicked using onKeyDown", async () => {
      const { queryByTestId } = render(<AddTask showAddTaskMain />);
    ...
    it("renders <AddTask /> for quick add task and then clicks cancel using onClick", async () => {
    ...
    it("renders <AddTask /> for quick add task and then clicks cancel using onKeyDown", async () => {
      const showQuickAddTask = true;
      const setShowQuickAddTask = jest.fn(() => !showQuickAddTask);
      const { queryByTestId } = render(
        <AddTask setShowQuickAddTask={setShowQuickAddTask} showQuickAddTask />
